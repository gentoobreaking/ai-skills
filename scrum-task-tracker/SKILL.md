---
name: scrum-task-tracker
description: Scrum 專案管理與任務追蹤標準流程。確保所有專案遵循統一的任務拆分、執行、驗證和報告規範。
metadata:
  emoji: "📋"
---
...
**驗證任務存放**：`$IDEAS2TASKS_TASKS_DIR/_verification/`
...
AI: 建立 $IDEAS2TASKS_TASKS_DIR/dashboard-tool/ 結構
    建立 README.md
    等待用戶提供需求
```
